...
// Variables
const rootDomain = "zentyameliandyputrixap2.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "zenty"; // Ganti dengan nama workers kalian
const apiKey = ""; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = ""; // Ganti dengan email yang kalian gunakan
const accountID = "cfa18975a7e3bcd776f307ece87ceda1"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "cfa18975a7e3bcd776f307ece87ceda1"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
